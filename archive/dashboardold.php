    ...
    <div class="dropdown open">
      ...
      <div>
        <form id="addFundingForm" class="neatForm">
          <input type="number" id="add_funding_amount" name="add_funding_amount" placeholder="Amount to Add (USD)"
            required />
        ...
        <div class="dropdown open">
          ...
          <div>
            <form id="removeGroupForm" class="neatForm">
              <input type="number" id="remove_group_id" name="remove_group_id" placeholder="Group ID to Remove"
                required />
